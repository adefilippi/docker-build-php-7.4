...
PHP_EXTENSIONS="opcache bcmath bz2 calendar exif gd gettext gmp json intl mcrypt mysqli recode pdo_mysql pdo_oci pdo_odbc pdo_pgsql pdo_sqlite pgsql shmop soap sockets sysvmsg sysvsem sysvshm tidy xsl mysqli pdo_mysql wddx zip pcntl"
