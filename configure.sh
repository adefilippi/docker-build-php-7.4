...
PHP_EXTENSIONS="opcache bcmath bz2 calendar exif gd gettext gmp json intl mysqli  pdo_mysql pdo_oci pdo_odbc pdo_pgsql pdo_sqlite pgsql shmop soap sockets sysvmsg sysvsem sysvshm tidy xsl zip pcntl"
